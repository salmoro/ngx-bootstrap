...
BsModalRef.ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: BsModalRef, factory: BsModalRef.ɵfac, providedIn: 'platform' });
(function () {
...
ModalContainerComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: ModalContainerComponent, selectors: [["modal-container"]], hostAttrs: ["role", "dialog", "tabindex", "-1", 1, "modal"], hostVars: 3, hostBindings: function ModalContainerComponent_HostBindings(rf, ctx) {
        if (rf & 1) {
...
ModalDirective.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: ModalDirective, selectors: [["", "bsModal", ""]], hostBindings: function ModalDirective_HostBindings(rf, ctx) {
        if (rf & 1) {
...
BsModalService.ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: BsModalService, factory: BsModalService.ɵfac, providedIn: 'platform' });
(function () {
