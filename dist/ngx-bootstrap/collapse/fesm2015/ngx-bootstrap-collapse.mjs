...
CollapseDirective.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: CollapseDirective, selectors: [["", "collapse", ""]], hostVars: 9, hostBindings: function CollapseDirective_HostBindings(rf, ctx) {
        if (rf & 2) {
...
CollapseModule.ɵmod = /*@__PURE__*/ i0.ɵɵdefineNgModule({ type: CollapseModule });
